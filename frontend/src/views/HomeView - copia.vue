<template>
  <div class="home-view">
    ...
    <div>
    <h1 class="blinking-text">¡OFERTAS EN CABOTAJE!</h1>
    </div>
    ...
    <div class="flight-card"
     ...
     :class="{ centered: index === centeredIndex }">
      ...
      <div class="flight-info">
        ...
        <span class="precio-original">u$s {{ vuelo.precio }}</span>
    ...
    async cargarVuelos() {
      try {
        const idsDeseados = [
          ...
          "4a6f021c-c250-4d8d-b860-7ebdb54572db"
        ];
...
.gif {
  ...
  display: block;
  border-radius: 20px;
  border: 5px solid #f3f4f5; /* ancho, estilo y color del borde */
